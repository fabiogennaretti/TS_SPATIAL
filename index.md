...
2. [Tests de randomisation<!-- (solutions)-->](labos/02-Tests_randomisation.html) ([PDF](labos/02R-Tests_randomisation.pdf)) - Données: [sablefish.csv](donnees/sablefish.csv)
