...
|    type    |    POURQUOI         |corrige pour biais  |   ok avec assymetrie  |
|:-----------|:--------------------:|:----------------:|:----------------------:|
|normal      | simple, si n=petit  |   non             |        non            |
|quantile    | simple              |   non             |         oui           |
|base        | rapide , si n=petit |   oui              |        non           | 
|studentised | plus compliqué, 2x temp |    oui             |      non          |
|BCa         | best; lent          |    oui             |       oui            |
