...
*Rappel*: La fonction `qt(p, df)` permet d'obtenir pour une valeur `p` donnée par la valeur du quantile de la distribution $t$ avec `df` degrés de liberté.
...
b) Simulez 10 000 échantillons bootstrap pour la moyenne calculée en a). Quelle est sont erreur-type selon le bootstrap? Est-ce que cette statistique apparait biasée? 
